...
file_path='C:/Users/helene/OneDrive - SINTEF/Simvascular/results/AAA013_sim_0-15_1-9mill-6cycles/'
...
# export view
ExportView(file_path+'surface_flow_aorta.csv', view=spreadSheetView1, RealNumberPrecision=9)
...
# export view
ExportView(file_path+'surface_flow_right.csv', view=spreadSheetView1, RealNumberPrecision=9)
...
# export view
ExportView(file_path+'surface_flow_left.csv', view=spreadSheetView1, RealNumberPrecision=9)
